...
type Customer = { id: number; code: string; etablissement: string | null; nom: string | null; prenom: string | null }
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left pb-2 pr-3 font-medium text-gray-600 w-36">Prix unitaire (€)</th>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2 bg-blue-700 text-white rounded-lg text-sm font-medium hover:bg-blue-800 disabled:opacity-50 transition-colors"
          >
